    ...
    def refresh_me(self):
        ...
        for key, value in self.latest_stash[0].items():
            ...
            if key == 'Rings' or key == 'OneHandWeapons':
                ...
                colour = '#e60000'
            exec(f'self.{key}.configure(text="{itemtext_for_overlay[index]}{len(value)}", foreground="{colour}")')
            index += 1
...
###
    ...
    def overlay(self):
        if self.settings_data[0].replace(' ', '') != '':
            ...
            self.Helmets.config(takefocus=False, text='Helmets:', width='12')
            ...
            self.Rings.config(takefocus=False, text='Rings:', width='12')
            ...
            button_1_3.grid(column='6', row='1')
            ...
            button_1_4.grid(column='7', ipady='5', row='0', rowspan='2')
